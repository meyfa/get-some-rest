...
describe('client.ts', function () {
  ...
  describe('#request()', function () {
    it('can send GET requests', async function () {
      ...
      await expect(c.request('GET', '1337').expect(200)).to.eventually.equal('res1')
    })
    ...
    it('can send GET requests with headers', async function () {
      ...
      await expect(c.request('GET', '1338', undefined, {
        'X-Test': 'test-get-with-headers'
      }).expect(200)).to.eventually.equal('res2')
    })

    it('can send POST requests without data', async function () {
      const c = client(new URL('https://test.local/baz/'), fetchNetworkAdapter())
      mockPool.intercept({ path: '/baz/1339', method: 'POST' }).reply(200, 'res3')
      await expect(c.request('POST', '1339').expect(200)).to.eventually.equal('res3')
    })
    ...
    it('can send POST requests with data', async function () {
      ...
      await expect(c.request('POST', '1340', { foo: 'bar' }).expect(200)).to.eventually.equal('res4')
    })
    ...
    it('can send POST requests with data and headers', async function () {
      ...
      await expect(c.request('POST', '1341', { foo: 'bar' }, {
        'X-Test': 'test-post-with-headers'
      }).expect(200)).to.eventually.equal('res5')
    })
  })
  ...
  describe('#get()', function () {
    it('can send a request', async function () {
      const c = client(new URL('https://test.local/baz/'), fetchNetworkAdapter())
      mockPool.intercept({ path: '/baz/1337', method: 'GET' }).reply(200, 'res1')
      await expect(c.get('1337').expect(200)).to.eventually.equal('res1')
    })
  ...
  describe('#post()', function () {
    it('can send a request', async function () {
      ...
      await expect(c.post('1337').expect(200)).to.eventually.equal('res1')
    })
    ...
    it('can send a request with data', async function () {
      ...
      await expect(c.post('1338', { foo: 'bar' }).expect(200)).to.eventually.equal('res2')
    })
    ...
    it('can send a request with data and headers', async function () {
      ...
      await expect(c.post('1339', { foo: 'bar' }, {
        'X-Test': 'test-post-with-headers'
      }).expect(200)).to.eventually.equal('res3')
    })
  })
  ...
  describe('#put()', function () {
    it('can send a request', async function () {
      ...
      await expect(c.put('1337').expect(200)).to.eventually.equal('res1')
    })
    ...
    it('can send a request with data', async function () {
      ...
      await expect(c.put('1338', { foo: 'bar' }).expect(200)).to.eventually.equal('res2')
    })
    ...
    it('can send a request with data and headers', async function () {
      ...
      await expect(c.put('1339', { foo: 'bar' }, {
  ...
  describe('#patch()', function () {
    it('can send a request', async function () {
      ...
      await expect(c.patch('1337').expect(200)).to.eventually.equal('res1')
    })
    ...
    it('can send a request with data', async function () {
      ...
      await expect(c.patch('1338', { foo: 'bar' }).expect(200)).to.eventually.equal('res2')
    })
    ...
    it('can send a request with data and headers', async function () {
      ...
      await expect(c.patch('1339', { foo: 'bar' }, {
  ...
  describe('#delete()', function () {
    it('can send a request', async function () {
      ...
      await expect(c.delete('1337').expect(200)).to.eventually.equal('res1')
    })
